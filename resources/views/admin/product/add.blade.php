...
<div id="content" class="container-fluid">
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.product.addStore') }}" method="POST">
                @csrf
                <div class="row">
                    <!-- Mã nội bộ -->
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('internal_code') is-invalid @enderror" type="text" name="internal_code" id="internal_code" value="{{ old('internal_code') }}" placeholder="Ví dụ: URE-001">
                            @error('internal_code')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('short_name') is-invalid @enderror" type="text" name="short_name" id="short_name" value="{{ old('short_name') }}" placeholder="Ví dụ: Ure">
                            @error('short_name')
                                <small class="text-danger font-italic">{{ $message }}</small>
                            @enderror
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('international_name') is-invalid @enderror" type="text" name="international_name" id="international_name" value="{{ old('international_name') }}" placeholder="Ví dụ: Urea">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('international_code') is-invalid @enderror" type="text" name="international_code" id="international_code" value="{{ old('international_code') }}" placeholder="Ví dụ: UREA">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input class="form-control @error('unit') is-invalid @enderror" type="text" name="unit" id="unit" value="{{ old('unit') }}" placeholder="Ví dụ: Tấn, Kg, Bao...">
                            @error('unit')
                                <small class="text-danger font-italic">{{ $message }}</small>
                            @enderror
                        </div>
